...
func (x *EditListRequest) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *EditListRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *EditListRequest) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_list_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x6d,
	...
	0x09, 0x52, 0x06, 0x6c, 0x69, 0x73, 0x74, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x8a, 0x02,
	0x0a, 0x0b, 0x6c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x38, 0x0a,
	0x0b, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x79, 0x49, 0x44, 0x12, 0x12, 0x2e, 0x70,
	...
	0x73, 0x74, 0x73, 0x46, 0x6f, 0x72, 0x55, 0x73, 0x65, 0x72, 0x12, 0x17, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	0x3e, 0x0a, 0x0e, 0x4e, 0x65, 0x77, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x6f, 0x72, 0x55, 0x73, 0x65,
	0x72, 0x12, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4e, 0x65, 0x77, 0x4c, 0x69, 0x73,
...
var file_list_proto_depIdxs = []int32{
	...
	0, // 2: proto.listService.GetListByID:input_type -> proto.ListRequest
	2, // 3: proto.listService.GetListsForUser:input_type -> proto.UserListsRequest
	4, // 4: proto.listService.NewListForUser:input_type -> proto.NewListRequest
	5, // 5: proto.listService.EditList:input_type -> proto.EditListRequest
	1, // 6: proto.listService.GetListByID:output_type -> proto.ListResponse
	3, // 7: proto.listService.GetListsForUser:output_type -> proto.UserListsResponse
	1, // 8: proto.listService.NewListForUser:output_type -> proto.ListResponse
	1, // 9: proto.listService.EditList:output_type -> proto.ListResponse
...
type ListServiceClient interface {
	...
	NewListForUser(ctx context.Context, in *NewListRequest, opts ...grpc.CallOption) (*ListResponse, error)
...
func (c *listServiceClient) NewListForUser(ctx context.Context, in *NewListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	out := new(ListResponse)
	err := c.cc.Invoke(ctx, "/proto.listService/NewListForUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ListServiceServer interface {
	...
	NewListForUser(context.Context, *NewListRequest) (*ListResponse, error)
...
func (*UnimplementedListServiceServer) NewListForUser(context.Context, *NewListRequest) (*ListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewListForUser not implemented")
}
...
func _ListService_NewListForUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ListServiceServer).NewListForUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.listService/NewListForUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListServiceServer).NewListForUser(ctx, req.(*NewListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ListService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NewListForUser",
			Handler:    _ListService_NewListForUser_Handler,
		},
		{
			MethodName: "EditList",
